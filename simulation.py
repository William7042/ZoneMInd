...
def run_simulation(from_zones, to_zone, buffer_meters=804):
    ...
    # Keep only columns the frontend needs
    output = sim[["BBL", "ZoneDist1", "LotArea", "UnitsRes",
                  "near_subway", "far_before", "far_after",
                  "units_before", "units_after", "units_gained", "geometry"]]

    # Save GeoJSON for Person C
    ...
    return {
        ...
        "new_units": new_units,
        "top_neighborhoods": [],  # placeholder for now
        "displacement_risk": 0.0,  # placeholder, Commit 5 will fill this
